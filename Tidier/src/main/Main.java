...
public class Main {
	...
	//MainMenu
	public Main() {
		//Read tasks.dat first, and then insert to memory.
		fw.readFile(tasks);
		while (true) {
			Util.cls();
			displayLogo();
	...
	//Creation of tasks using TaskFactory.java to simplify the code.
	...
	public void viewTasks() {
		...
		// Array preprocessing by building the index of tasks and categorizing them.
		...
		//Output the tasks by each category or all categories.
		while (true) {
			Util.cls();
	...
	//Driver code to view the tasks in each array.
	...
	//Driver code to start tasks that implement the Timeable interface
	...
	//Driver code to delete the tasks when done.
